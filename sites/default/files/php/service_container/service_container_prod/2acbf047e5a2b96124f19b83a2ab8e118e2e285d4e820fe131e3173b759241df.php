...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    protected function getAccessManagerService()
    {
        ...
        $instance->addCheckService('access_check.node.preview', 'access', array(0 => '_node_preview_access'));
    ...
    {
        return $this->services['container.namespaces'] = new \ArrayObject(array('Drupal\\block' => '/var/www/dots/code/core/modules/block/src', 'Drupal\\block_content' => '/var/www/dots/code/core/modules/block_content/src', 'Drupal\\breakpoint' => '/var/www/dots/code/core/modules/breakpoint/src', 'Drupal\\ckeditor' => '/var/www/dots/code/core/modules/ckeditor/src', 'Drupal\\color' => '/var/www/dots/code/core/modules/color/src', 'Drupal\\comment' => '/var/www/dots/code/core/modules/comment/src', 'Drupal\\config' => '/var/www/dots/code/core/modules/config/src', 'Drupal\\contact' => '/var/www/dots/code/core/modules/contact/src', 'Drupal\\contextual' => '/var/www/dots/code/core/modules/contextual/src', 'Drupal\\datetime' => '/var/www/dots/code/core/modules/datetime/src', 'Drupal\\dblog' => '/var/www/dots/code/core/modules/dblog/src', 'Drupal\\editor' => '/var/www/dots/code/core/modules/editor/src', 'Drupal\\entity' => '/var/www/dots/code/core/modules/entity/src', 'Drupal\\entity_reference' => '/var/www/dots/code/core/modules/entity_reference/src', 'Drupal\\field' => '/var/www/dots/code/core/modules/field/src', 'Drupal\\field_ui' => '/var/www/dots/code/core/modules/field_ui/src', 'Drupal\\file' => '/var/www/dots/code/core/modules/file/src', 'Drupal\\filter' => '/var/www/dots/code/core/modules/filter/src', 'Drupal\\glue' => '/var/www/dots/code/modules/glue/src', 'Drupal\\help' => '/var/www/dots/code/core/modules/help/src', 'Drupal\\history' => '/var/www/dots/code/core/modules/history/src', 'Drupal\\image' => '/var/www/dots/code/core/modules/image/src', 'Drupal\\menu_link_content' => '/var/www/dots/code/core/modules/menu_link_content/src', 'Drupal\\menu_ui' => '/var/www/dots/code/core/modules/menu_ui/src', 'Drupal\\node' => '/var/www/dots/code/core/modules/node/src', 'Drupal\\options' => '/var/www/dots/code/core/modules/options/src', 'Drupal\\path' => '/var/www/dots/code/core/modules/path/src', 'Drupal\\quickedit' => '/var/www/dots/code/core/modules/quickedit/src', 'Drupal\\rdf' => '/var/www/dots/code/core/modules/rdf/src', 'Drupal\\search' => '/var/www/dots/code/core/modules/search/src', 'Drupal\\shortcut' => '/var/www/dots/code/core/modules/shortcut/src', 'Drupal\\system' => '/var/www/dots/code/core/modules/system/src', 'Drupal\\taxonomy' => '/var/www/dots/code/core/modules/taxonomy/src', 'Drupal\\text' => '/var/www/dots/code/core/modules/text/src', 'Drupal\\toolbar' => '/var/www/dots/code/core/modules/toolbar/src', 'Drupal\\tour' => '/var/www/dots/code/core/modules/tour/src', 'Drupal\\user' => '/var/www/dots/code/core/modules/user/src', 'Drupal\\views_ui' => '/var/www/dots/code/core/modules/views_ui/src', 'Drupal\\views' => '/var/www/dots/code/core/modules/views/src', 'Drupal\\standard' => '/var/www/dots/code/core/profiles/standard/src', 'Drupal\\Core\\TypedData' => '/var/www/dots/code/core/lib/Drupal/Core/TypedData', 'Drupal\\Core\\Field' => '/var/www/dots/code/core/lib/Drupal/Core/Field', 'Drupal\\Core\\Validation' => '/var/www/dots/code/core/lib/Drupal/Core/Validation', 'Drupal\\Core\\Mail' => '/var/www/dots/code/core/lib/Drupal/Core/Mail', 'Drupal\\Core\\Render' => '/var/www/dots/code/core/lib/Drupal/Core/Render', 'Drupal\\Core\\Entity' => '/var/www/dots/code/core/lib/Drupal/Core/Entity', 'Drupal\\Component\\Annotation' => '/var/www/dots/code/core/lib/Drupal/Component/Annotation'));
    }
    ...
    {
        $this->services['exception_controller'] = $instance = new \Drupal\Core\Controller\ExceptionController($this->get('content_negotiation'), $this->get('title_resolver'), $this->get('html_page_renderer'), $this->get('html_fragment_renderer'), $this->get('string_translation'), $this->get('url_generator'), $this->get('logger.factory'));
    ...
    {
        return $this->services['form_builder'] = new \Drupal\Core\Form\FormBuilder($this->get('form_validator'), $this->get('form_submitter'), $this->get('module_handler'), $this->get('keyvalue.expirable'), $this->get('event_dispatcher'), $this->get('request_stack'), $this->get('class_resolver'), $this->get('theme.manager'), $this->get('csrf_token', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('http_kernel', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['path.validator'] = new \Drupal\Core\Path\PathValidator($this->get('router'), $this->get('router.route_provider'), $this->get('request_stack'));
    }
    ...
    {
        return $this->services['theme.manager'] = new \Drupal\Core\Theme\ThemeManager($this->get('theme_handler'), $this->get('theme.registry'), $this->get('theme.negotiator'), $this->get('theme.initialization'), $this->get('request_stack'));
    }
    ...
    {
        return $this->services['theme_handler'] = new \Drupal\Core\Extension\ThemeHandler($this->get('config.factory'), $this->get('module_handler'), $this->get('state'), $this->get('info_parser'), $this->get('logger.channel.default'), $this->get('asset.css.collection_optimizer'), $this->get('config.installer'), $this->get('router.builder'));
    }
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/var/www/dots/code');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.modules' => array(
                ...
                'glue' => array(
                    'type' => 'module',
                    'pathname' => 'modules/glue/glue.info.yml',
                    'filename' => 'glue.module',
                ),
                'help' => array(
                    'type' => 'module',
            ...
            'container.namespaces' => array(
                'Drupal\\block' => '/var/www/dots/code/core/modules/block/src',
                'Drupal\\block_content' => '/var/www/dots/code/core/modules/block_content/src',
                'Drupal\\breakpoint' => '/var/www/dots/code/core/modules/breakpoint/src',
                'Drupal\\ckeditor' => '/var/www/dots/code/core/modules/ckeditor/src',
                'Drupal\\color' => '/var/www/dots/code/core/modules/color/src',
                'Drupal\\comment' => '/var/www/dots/code/core/modules/comment/src',
                'Drupal\\config' => '/var/www/dots/code/core/modules/config/src',
                'Drupal\\contact' => '/var/www/dots/code/core/modules/contact/src',
                'Drupal\\contextual' => '/var/www/dots/code/core/modules/contextual/src',
                'Drupal\\datetime' => '/var/www/dots/code/core/modules/datetime/src',
                'Drupal\\dblog' => '/var/www/dots/code/core/modules/dblog/src',
                'Drupal\\editor' => '/var/www/dots/code/core/modules/editor/src',
                'Drupal\\entity' => '/var/www/dots/code/core/modules/entity/src',
                'Drupal\\entity_reference' => '/var/www/dots/code/core/modules/entity_reference/src',
                'Drupal\\field' => '/var/www/dots/code/core/modules/field/src',
                'Drupal\\field_ui' => '/var/www/dots/code/core/modules/field_ui/src',
                'Drupal\\file' => '/var/www/dots/code/core/modules/file/src',
                'Drupal\\filter' => '/var/www/dots/code/core/modules/filter/src',
                'Drupal\\glue' => '/var/www/dots/code/modules/glue/src',
                'Drupal\\help' => '/var/www/dots/code/core/modules/help/src',
                'Drupal\\history' => '/var/www/dots/code/core/modules/history/src',
                'Drupal\\image' => '/var/www/dots/code/core/modules/image/src',
                'Drupal\\menu_link_content' => '/var/www/dots/code/core/modules/menu_link_content/src',
                'Drupal\\menu_ui' => '/var/www/dots/code/core/modules/menu_ui/src',
                'Drupal\\node' => '/var/www/dots/code/core/modules/node/src',
                'Drupal\\options' => '/var/www/dots/code/core/modules/options/src',
                'Drupal\\path' => '/var/www/dots/code/core/modules/path/src',
                'Drupal\\quickedit' => '/var/www/dots/code/core/modules/quickedit/src',
                'Drupal\\rdf' => '/var/www/dots/code/core/modules/rdf/src',
                'Drupal\\search' => '/var/www/dots/code/core/modules/search/src',
                'Drupal\\shortcut' => '/var/www/dots/code/core/modules/shortcut/src',
                'Drupal\\system' => '/var/www/dots/code/core/modules/system/src',
                'Drupal\\taxonomy' => '/var/www/dots/code/core/modules/taxonomy/src',
                'Drupal\\text' => '/var/www/dots/code/core/modules/text/src',
                'Drupal\\toolbar' => '/var/www/dots/code/core/modules/toolbar/src',
                'Drupal\\tour' => '/var/www/dots/code/core/modules/tour/src',
                'Drupal\\user' => '/var/www/dots/code/core/modules/user/src',
                'Drupal\\views_ui' => '/var/www/dots/code/core/modules/views_ui/src',
                'Drupal\\views' => '/var/www/dots/code/core/modules/views/src',
                'Drupal\\standard' => '/var/www/dots/code/core/profiles/standard/src',
                'Drupal\\Core\\TypedData' => '/var/www/dots/code/core/lib/Drupal/Core/TypedData',
                'Drupal\\Core\\Field' => '/var/www/dots/code/core/lib/Drupal/Core/Field',
                'Drupal\\Core\\Validation' => '/var/www/dots/code/core/lib/Drupal/Core/Validation',
                'Drupal\\Core\\Mail' => '/var/www/dots/code/core/lib/Drupal/Core/Mail',
                'Drupal\\Core\\Render' => '/var/www/dots/code/core/lib/Drupal/Core/Render',
                'Drupal\\Core\\Entity' => '/var/www/dots/code/core/lib/Drupal/Core/Entity',
                'Drupal\\Component\\Annotation' => '/var/www/dots/code/core/lib/Drupal/Component/Annotation',
            ),
